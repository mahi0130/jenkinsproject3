...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.VENDOR_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=VendorListCtl.OP_SEARCH%>"> &emsp; <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=VendorListCtl.OP_RESET%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="VendorCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">vendor List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
