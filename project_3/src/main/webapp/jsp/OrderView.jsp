...
<script src="<%=ORSView.APP_CONTEXT%>/js/ValidateToinpute.js"></script>
<style type="text/css">
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="customerName" onkeypress="return validateInput(event)"
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											...
											map.put("Air conditinor", "Air conditinor");
											map.put("Washing Machine", "Washing Machine");
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
												<i class="fas fa-sort-amount-down grey-text"
													style="font-size: 1rem;"></i>
											</div>
										</div>
